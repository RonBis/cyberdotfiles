...
-- {{{ Custom Startup Widget setups
AudioState.sync()
-- }}}

-- {{{ Variable definitions
-- Themes define colours, icons, font and wallpapers.
beautiful.init("/home/roni/.config/awesome/theme.lua")
...
mylauncher = awful.widget.launcher({
    image = "/home/roni/Pictures/stray-game-logo.svg",
    menu = mymainmenu
})
...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    awful.tag({ "A", "R", "C", "H", "L", "I", "N", "U", "X" }, s, awful.layout.layouts[2])
    ...
    s.mytasklist._dynamic_bar_id = "dynamic_bar:tasklist"
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key(
        ...
        { description = "pause media player", group = "multimedia controls" }
    ),
    ...
    awful.key(
        ...
        { description = "play media player", group = "multimedia controls" }
    ),

    awful.key(
        {}, "XF86AudioPrev",
        function()
            MediaPlayerState.play_previous()
        end,
        { description = "play previous media", group = "multimedia controls" }
    ),

    awful.key(
        {}, "XF86AudioNext",
        function()
            MediaPlayerState.play_next()
        end,
        { description = "play next media", group = "multimedia controls" }
    ),
